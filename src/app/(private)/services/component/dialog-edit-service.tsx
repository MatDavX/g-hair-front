...
import { editService } from '../action-server';
...
export function EditServiceDialog({ service }: NewServiceDialogProps) {
  const [isOpen, setIsOpen] = React.useState(false);
  const [{ errors, message, success }, handleSubmit, isPending] = useFormState(
    e => editService(e, service.id),
    false,
    () => {
      setIsOpen(false);
    ...
    <Dialog onOpenChange={setIsOpen} open={isOpen}>
      ...
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>Editar serviço.</DialogDescription>
        </DialogHeader>
        <form
          id="form-service"
